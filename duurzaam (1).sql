...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 30 jan 2025 om 10:57
...
CREATE TABLE `artikel` (
  ...
  `verkoop_gereed` tinyint(1) DEFAULT NULL,
  `artikel_prijs` decimal(10,2) DEFAULT NULL,
  `datum_ingevuld` datetime DEFAULT NULL
...
INSERT INTO `artikel` (`id`, `categorie_id`, `naam`, `prijs_ex_btw`, `soort`, `type`, `merk`, `verkoop_gereed`, `artikel_prijs`, `datum_ingevuld`) VALUES
(1, 1, 'Soroosh', 0.00, 'ezel', 'dier', 'nike', 1, 2.00, '2025-01-30 10:25:36'),
(2, 1, 'Soroosh', 0.00, 'ezel', 'dier', 'nike', 1, 2.00, '2025-01-30 10:27:24');
...
(4, 'Mo', '$2y$10$1zCzwBeXtz9ggW.dVC0VAuakePxtspZcuMfcKwMgR/0GgJy.x0gUu', 'magazijnmederwerker', 0);
...
(1, 'Omer', 'Turkije', '06721', 'Lalala', 'Jai-Mancham@hotmail.com');
